...
Here's an example of what you see in the console window if you run the sample application from the command line and go to URL `http://localhost:5000/api/todo/0`:
